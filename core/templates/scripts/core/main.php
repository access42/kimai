...
<body onload="kimai_onload();">
    ...
    <div id="top">
        ...
        <header id="logo" role="banner">
            <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin'])?>/grfx/g3_logo.png" width="151" height="52" alt="" />
        </header>
...
<div class="lists clear" style="display:none">
	...
	<div class="lists-elt" id="lists-customers">
		...
		<div id="customers_foot" class="lists-foot clear">    
			...
			<?php endif; ?>
			<button class="selectAllLink" onclick="lists_filter_select_all('customers'); $(this).blur(); return false;"></button>
			<button class="deselectAllLink" onclick="lists_filter_deselect_all('customers'); $(this).blur(); return false;"></button>
			<button href="#" class="selectInvertLink" onclick="lists_filter_select_invert('customers'); $(this).blur(); return false;"></button>
		</div>
	</div>
	...
	<div class="lists-elt" id="lists-projects">
		...
		<div id="projects_foot" class="lists-foot clear">
			...
			<?php endif; ?>
			<button class="selectAllLink" onclick="lists_filter_select_all('projects'); $(this).blur(); return false;"></button>
			<button class="deselectAllLink" onclick="lists_filter_deselect_all('projects'); $(this).blur(); return false;"></button>
			<button class="selectInvertLink" onclick="lists_filter_select_invert('projects'); $(this).blur(); return false;"></button>
		</div>
	</div>
	...
	<div class="lists-elt" id="lists-activities">
		...
		<div id="activities_foot" class="lists-foot clear">
			...
			<?php endif; ?>
			<button class="selectAllLink" onclick="lists_filter_select_all('activities'); $(this).blur(); return false;"></button>
			<button class="deselectAllLink" onclick="lists_filter_deselect_all('activities'); $(this).blur(); return false;"></button>
			<button class="selectInvertLink" onclick="lists_filter_select_invert('activities'); $(this).blur(); return false;"></button>
		</div>
	</div>
